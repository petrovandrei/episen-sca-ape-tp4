...
/* harmony default export */ __webpack_exports__["default"] = ("<input [(ngModel)]=\"order\">\n<button (click)=\"sendOrder()\">Valider</button>\n");
...
let AppComponent = class AppComponent {
    constructor(router, route, ordersService) {
        ...
        this.title = 'episen-sca-ape-front';
    }
    sendOrder() {
...
let OrdersService = class OrdersService {
    ...
    addOrder(order) {
        this.http.post('http://back/add/order', order).subscribe(data => {
            console.log("got it");
        });
    }
};
...
module.exports = __webpack_require__(/*! /Users/pluton/episen-sca-ape-front/src/main.ts */"./src/main.ts");
